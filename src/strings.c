...
const u8 gText_ThisIsAPokemon[] = _("I'm sure you're familiar with Pokémon.{PAUSE 96}\p");
...
const u8 gText_DefaultNameRiley[] = _("Riley");
const u8 gText_DefaultNameMorgan[] = _("Morgan");
...
const u8 gText_DefaultNameEmery[] = _("Emery");
const u8 gText_DefaultNameRowan[] = _("Rowan");
const u8 gText_DefaultNameReese[] = _("Reese");
const u8 gText_DefaultNameBlair[] = _("Blair");
const u8 gText_DefaultNameFinley[] = _("Finley");
const u8 gText_DefaultNameDakota[] = _("Dakota");
const u8 gText_DefaultNameShiloh[] = _("Shiloh");
const u8 gText_DefaultNamePeyton[] = _("Peyton");
const u8 gText_DefaultNamePhoenix[] = _("Phoenix");
const u8 gText_DefaultNameSage[] = _("Sage");
const u8 gText_DefaultNameEllis[] = _("Ellis");
const u8 gText_DefaultNameLinden[] = _("Linden");
const u8 gText_DefaultNameMarlowe[] = _("Marlowe");
const u8 gText_DefaultNameOcean[] = _("Ocean");
const u8 gText_DefaultNameIndigo[] = _("Indigo");
const u8 gText_DefaultNameAsh[] = _("Ash");
const u8 gText_DefaultNameZephyr[] = _("Zephyr");
const u8 gText_DefaultNameRiver[] = _("River");
const u8 gText_DefaultNameTatum[] = _("Tatum");
const u8 gText_DefaultNameHollis[] = _("Hollis");
const u8 gText_DefaultNameBriar[] = _("Briar");
const u8 gText_DefaultNameLior[] = _("Lior");
const u8 gText_DefaultNameOnyx[] = _("Onyx");
const u8 gText_DefaultNameStorm[] = _("Storm");
const u8 gText_DefaultNameNova[] = _("Nova");
const u8 gText_DefaultNameWren[] = _("Wren");
const u8 gText_DefaultNameAri[] = _("Ari");
const u8 gText_DefaultNameCove[] = _("Cove");
const u8 gText_DefaultNameJules[] = _("Jules");
const u8 gText_DefaultNameRemy[] = _("Remy");

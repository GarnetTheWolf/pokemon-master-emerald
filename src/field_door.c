...
static const u8 sDoorAnimTiles_DarkwingHouse[] = INCBIN_U8("graphics/door_anims/darkwing_house.4bpp");
...
static const u8 sDoorAnimPalettes_DarkwingHouse[] = {9, 9, 9, 9, 9, 9, 9, 9};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Darkwing_Door_Darkwing_House,                 DOOR_SOUND_NORMAL,  DOOR_SIZE_1x1, sDoorAnimTiles_DarkwingHouse, sDoorAnimPalettes_DarkwingHouse},
    {},
};
